...
def light_gbm_classifier(threshold, rfe=False, rfe_feature_n=10, train_light=True):
    ...
    with open(os.path.join(os.path.pardir, "data", "processed", "final", "median_model_light.pkl"),
              'rb') as model_file:
        regression_median = pickle.load(model_file)

    with open(os.path.join(os.path.pardir, "data", "processed", "final", "low_model_10_light.pkl"),
              'rb') as model_file:
        regression_lower10 = pickle.load(model_file)

    with open(os.path.join(os.path.pardir, "data", "processed", "final", "low_model_5_light.pkl"),
              'rb') as model_file:
